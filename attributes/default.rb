...
default['travis_java']['ibmjava']['arch'] = 'i386'
default['travis_java']['ibmjava']['arch'] = 'x86_64' if kernel['machine'] =~ /x86_64/
default['travis_java']['ibmjava8']['jvm_name'] = 'java-8-ibm'
default['travis_java']['ibmjava9']['jvm_name'] = 'java-9-ibm'
